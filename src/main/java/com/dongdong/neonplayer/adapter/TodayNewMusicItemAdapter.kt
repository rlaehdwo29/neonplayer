...
import com.dongdong.neonplayer.data.TodayNewMusicData
import java.io.FileNotFoundException
import java.io.IOException


class TodayNewMusicItemAdapter : RecyclerView.Adapter<TodayNewMusicItemAdapter.ViewHolder> {

    var mcontext : Context? = null
    var itemList : ArrayList<TodayNewMusicData>? = null
    ...
    constructor(context : Context,list : ArrayList<TodayNewMusicData>){
